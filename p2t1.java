...
public class p2t1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. Audífonos $500");
        ...
        System.out.println("12. Lámpara $1,200");
        System.out.println("13. Cámara $1,500");
        ...
        System.out.println("¿Cuántos productos desea comprar? (Entre 1 y 20)");
        while (cantidadProductos < 1 || cantidadProductos > 20) {
            ...
            if (cantidadProductos < 1 || cantidadProductos > 20) {
                System.out.println("El número debe estar entre 1 y 20, ingrese nuevamente:");
            }
        }

        for (int i = 0; i < cantidadProductos; i++) {
            System.out.println("Ingrese el número del producto " + (i + 1) + ":");
